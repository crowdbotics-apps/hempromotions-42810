"""
Django settings for hempromotions_42810 project.
...
ROOT_URLCONF = 'hempromotions_42810.urls'
...
WSGI_APPLICATION = 'hempromotions_42810.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hempromotions_42810 API",
    "DESCRIPTION": "API documentation for hempromotions_42810 App",
    "VERSION": "v1",
}
